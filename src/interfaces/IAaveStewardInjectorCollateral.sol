...
/**
 * @title IAaveStewardInjectorCollateral
 * @author BGD Labs
 * @notice Defines the interface for the injector contract to automate collateral updates on Risk Steward.
 **/
interface IAaveStewardInjectorCollateral is IAaveStewardInjectorBase {
  /**
